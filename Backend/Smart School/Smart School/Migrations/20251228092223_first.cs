    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttendanceNotifications", x => x.NotificationId);
                    table.ForeignKey(
                        name: "FK_AttendanceNotifications_Attendances_AttendanceId",
                        column: x => x.AttendanceId,
                        principalTable: "Attendances",
                        principalColumn: "AttendanceId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttendanceNotifications_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceNotifications_AttendanceId",
                table: "AttendanceNotifications",
                column: "AttendanceId");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceNotifications_StudentId",
                table: "AttendanceNotifications",
                column: "StudentId");
